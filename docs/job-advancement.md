...
- **기본 스탯 배율**: 전직 직업의 스탯 배율이 적용됩니다. (기본 직업보다 향상)
...
#### 2.5 스탯 계산 공식
```
최종 스탯 = (기본 스탯 × 전직 배율) + SP 업그레이드 보너스

예시 (버서커 전직):
- 기존 HP: 1000, SP로 +200 업그레이드
- 버서커 HP 배율: 0.8
- 최종 HP = (1000 × 0.8) + 200 = 1000
```
...
#### 3.4 2차 강화 스탯 계산 공식
```
2차 강화 후 스탯 = 1차 전직 스탯 × 1.2

예시 (버서커 2차 강화):
- 1차 전직 HP: 800 (기본 1000 × 0.8)
- 2차 강화 후 HP: 800 × 1.2 = 960
- SP 업그레이드 +200 포함 시: 960 + 200 = 1160
```
...
#### 싱글플레이
- [ ] 레벨 15 미만에서 전직 버튼 비활성화 확인
- [ ] 레벨 15에서 전직 버튼 활성화 확인
- [ ] 전직 선택 UI 정상 표시
- [ ] 전직 후 스탯 배율 정상 적용
- [ ] 전직 후 SP 업그레이드 유지 확인
- [ ] 전직 후 스킬 변경 확인
- [ ] 전직 후 이미지 변경 확인
- [ ] 레벨 50 도달 시 자동 2차 강화 확인
- [ ] 2차 강화 시 알림 표시 확인
- [ ] 2차 강화 후 스탯 20% 증가 확인
- [ ] 2차 강화 후 이미지 변경 확인
