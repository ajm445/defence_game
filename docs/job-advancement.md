...
**W 스킬 - 암흑 찌르기 (Dark Pierce):** `heavy_strike`
- 쿨다운: 4초
- 효과: 1초 시전 후 전방 직선 150px×80px 범위에 350% 데미지, HP 20% 소모

**E 스킬 - 어둠의 칼날 (Dark Blade):** `dark_blade`
- 쿨다운: 없음 (토글, 재사용 딜레이 2초)
- 효과: 토글 온/오프, 초당 HP 5% 소모, 주변 150px 내 적에게 초당 공격력 120% 데미지, HP ≤10% 또는 기절 시 자동 해제
...
| 기사 | 방패 돌진 | 다크나이트 | 암흑 찌르기 (1초 시전 + 350% 데미지 + HP 20% 소모) | `heavy_strike` |
