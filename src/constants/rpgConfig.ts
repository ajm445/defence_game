...
export const CLASS_SKILLS = {
  warrior: {
    q: {
      ...
      name: '강타',
      key: 'Q',
      cooldown: BASE_SKILL_COOLDOWNS.warrior.qCd,
    ...
    w: {
      ...
      name: '돌진',
      key: 'W',
      cooldown: BASE_SKILL_COOLDOWNS.warrior.wCd,
    ...
    e: {
      ...
      name: '광전사',
      key: 'E',
      cooldown: BASE_SKILL_COOLDOWNS.warrior.eCd,
  ...
  archer: {
    q: {
      ...
      name: '속사',
      key: 'Q',
      cooldown: BASE_SKILL_COOLDOWNS.archer.qCd,
    ...
    w: {
      ...
      name: '관통 화살',
      key: 'W',
      cooldown: BASE_SKILL_COOLDOWNS.archer.wCd,
    ...
    e: {
      ...
      name: '화살 비',
      key: 'E',
      cooldown: BASE_SKILL_COOLDOWNS.archer.eCd,
  ...
  knight: {
    q: {
      ...
      name: '방패 타격',
      key: 'Q',
      cooldown: BASE_SKILL_COOLDOWNS.knight.qCd,
    ...
    w: {
      ...
      name: '방패 돌진',
      key: 'W',
      cooldown: BASE_SKILL_COOLDOWNS.knight.wCd,
    ...
    e: {
      ...
      name: '철벽 방어',
      key: 'E',
      cooldown: BASE_SKILL_COOLDOWNS.knight.eCd,
  ...
  mage: {
    q: {
      ...
      name: '마법 화살',
      key: 'Q',
      cooldown: BASE_SKILL_COOLDOWNS.mage.qCd,
    ...
    w: {
      ...
      name: '화염구',
      key: 'W',
      cooldown: BASE_SKILL_COOLDOWNS.mage.wCd,
    ...
    e: {
      ...
      name: '운석 낙하',
      key: 'E',
      cooldown: BASE_SKILL_COOLDOWNS.mage.eCd,
...
export const ADVANCED_W_SKILLS: Record<AdvancedHeroClass, AdvancedSkillConfig> = {
  ...
  berserker: {
    ...
    nameEn: 'Blood Rush',
    key: 'W',
    cooldown: ADVANCED_SKILL_COOLDOWNS.berserker.wCd,
  ...
  guardian: {
    ...
    key: 'W',
    cooldown: ADVANCED_SKILL_COOLDOWNS.guardian.wCd,
  ...
  sniper: {
    ...
    key: 'W',
    cooldown: ADVANCED_SKILL_COOLDOWNS.sniper.wCd,
  ...
  ranger: {
    ...
    nameEn: 'Multi Arrow',
    key: 'W',
    cooldown: ADVANCED_SKILL_COOLDOWNS.ranger.wCd,
  ...
  paladin: {
    ...
    nameEn: 'Holy Charge',
    key: 'W',
    cooldown: ADVANCED_SKILL_COOLDOWNS.paladin.wCd,
  ...
  darkKnight: {
    ...
    nameEn: 'Dark Pierce',
    key: 'W',
    cooldown: ADVANCED_SKILL_COOLDOWNS.darkKnight.wCd,
  ...
  archmage: {
    ...
    nameEn: 'Inferno',
    key: 'W',
    cooldown: ADVANCED_SKILL_COOLDOWNS.archmage.wCd,
  ...
  healer: {
    ...
    key: 'W',
    cooldown: ADVANCED_SKILL_COOLDOWNS.healer.wCd,
...
export const ADVANCED_E_SKILLS: Record<AdvancedHeroClass, AdvancedSkillConfig> = {
  ...
  berserker: {
    ...
    nameEn: 'Rage',
    key: 'E',
    cooldown: ADVANCED_SKILL_COOLDOWNS.berserker.eCd,
  ...
  guardian: {
    ...
    nameEn: 'Shield',
    key: 'E',
    cooldown: ADVANCED_SKILL_COOLDOWNS.guardian.eCd,
  ...
  sniper: {
    ...
    nameEn: 'Snipe',
    key: 'E',
    cooldown: ADVANCED_SKILL_COOLDOWNS.sniper.eCd,
  ...
  ranger: {
    ...
    nameEn: 'Arrow Storm',
    key: 'E',
    cooldown: ADVANCED_SKILL_COOLDOWNS.ranger.eCd,
  ...
  paladin: {
    ...
    nameEn: 'Divine Light',
    key: 'E',
    cooldown: ADVANCED_SKILL_COOLDOWNS.paladin.eCd,
  ...
  darkKnight: {
    ...
    nameEn: 'Dark Blade',
    key: 'E',
    cooldown: ADVANCED_SKILL_COOLDOWNS.darkKnight.eCd,
  ...
  archmage: {
    ...
    key: 'E',
    cooldown: ADVANCED_SKILL_COOLDOWNS.archmage.eCd,
  ...
  healer: {
    ...
    key: 'E',
    cooldown: ADVANCED_SKILL_COOLDOWNS.healer.eCd,
