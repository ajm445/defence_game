...
export type GameScreen = 'menu' | 'gameTypeSelect' | 'modeSelect' | 'difficultySelect' | 'lobby' | 'countdown' | 'game' | 'gameover' | 'paused' | 'rpgClassSelect' | 'rpgCoopLobby' | 'login' | 'profile' | 'rpgTutorial' | 'classEncyclopedia';
