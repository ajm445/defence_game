...
export type GameScreen = 'menu' | 'gameTypeSelect' | 'modeSelect' | 'difficultySelect' | 'lobby' | 'countdown' | 'game' | 'gameover' | 'paused' | 'rpgCoopLobby' | 'login' | 'profile' | 'rpgTutorial' | 'classEncyclopedia';
