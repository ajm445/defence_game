...
| **다크나이트** | 강타 | 4초 | 어둠의 칼날 (토글) | 2초 딜레이 | 기본공격 20% 피해흡혈, HP 소모형 |
...
### V1.22.4 (현재)
- **다크나이트 밸런스 조정**
  - W스킬(강타): 부채꼴(±45도) → 전방 직선 120px×80px 공격 범위로 변경, 이펙트 개선
...
- **다크나이트 스킬 리워크** - "HP를 소모하여 강한 데미지를 내는 암흑기사" 컨셉
  - W스킬: 암흑 베기(돌진) → 강타(Heavy Strike) - 1초 시전, HP 11% 소모, 350% 데미지, 전방 120px ±45도, 4초 쿨
