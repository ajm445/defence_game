...
| 기사 | 120 골드 + 20 나무 + 30 돌 | 250 | 10 | 35 | 근접 탱커 (높은 체력) |
| 마법사 | 150 골드 + 10 수정 | 40 | 50 | 180 | 범위 공격 (AOE 50px) |
...
| 광부 | 40 골드 + 5 나무 | 70 | 채집 0.8/초 | 돌 채집 |
| 채집꾼 | 65 골드 | 50 | 채집 1.2/초 | 약초 채집 (수정 확률) |
| 금광부 | 100 골드 + 20 나무 | 70 | 채집 1.5/초 | 골드 채집 (광산) |
| 힐러 | 70 골드 + 15 약초 | 60 | 광역 회복 10HP/초 | 전투 유닛만 치료 (범위 100px) |

### 건설

| 행동 | 비용 | 효과 |
|------|------|------|
| 벽 건설 | 35 나무 + 20 돌 | 방어벽 생성 (HP 200) |
| 기지 업그레이드 | 레벨별 증가 | 기지 HP +200, 골드 수입 +1/초 |

#### 기지 업그레이드 비용 (레벨당 1.5배 증가, 최대 5레벨)
...
| 어려움 | 2초 | 95% | 1500 | 다중 소환 + 2분마다 대량 발생 |
