...
| **RPG 모드** | 영웅 선택, 스킬 전투, 웨이브 서바이벌 | 싱글 |
...
| 키 | 스킬 | 설명 |
|----|------|------|
| **Q** | 기본 공격 | 마우스 방향으로 기본 공격 |
| **W** | 스킬 | 직업별 고유 스킬 (돌진, 관통 화살, 방패 돌진, 화염구) |
| **E** | 궁극기 | 강력한 궁극기 (광전사, 화살 비, 철벽 방어, 운석 낙하) |
...
- **조작법 안내 업데이트**
  - 하단 안내 텍스트 수정: `우클릭: 이동 | Q: 기본 공격 | W: 스킬 | E: 궁극기 | C: 사거리 | Space: 카메라`
- **버그 수정**
