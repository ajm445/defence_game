...
> **🚧 진행 중: 모바일/태블릿 반응형 UI**
> 터치 디바이스(폰/태블릿)에서 게임을 플레이할 수 있도록 반응형 UI 및 터치 입력 시스템을 개발 중입니다.
> 가상 조이스틱, 터치 스킬 버튼, 핀치 줌, 전체화면, 화면 방향 안내 등이 포함됩니다.
> 상세 문서: [`docs/mobile-responsive.md`](docs/mobile-responsive.md)
