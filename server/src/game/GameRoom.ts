...
export class GameRoom {
  ...
  private initializeResourceNodes(): void {
    ...
    const treePositions = [
      // 왼쪽 (플레이어 측)
      { x: 400, y: 300 }, { x: 450, y: 600 }, { x: 400, y: 900 },
      { x: 450, y: 1200 }, { x: 400, y: 1500 }, { x: 450, y: 1700 },
      { x: 600, y: 400 }, { x: 600, y: 1600 },
      // 오른쪽 (적 측)
      { x: 2600, y: 300 }, { x: 2550, y: 600 }, { x: 2600, y: 900 },
      { x: 2550, y: 1200 }, { x: 2600, y: 1500 }, { x: 2550, y: 1700 },
      { x: 2400, y: 400 }, { x: 2400, y: 1600 },
    ];
    ...
    // 바위 노드 (맵 중앙 10개)
    const rockPositions = [
      { x: 1200, y: 400 }, { x: 1400, y: 600 }, { x: 1600, y: 400 },
      { x: 1800, y: 600 }, { x: 1500, y: 1000 },
      { x: 1200, y: 1400 }, { x: 1400, y: 1600 }, { x: 1600, y: 1400 },
      { x: 1800, y: 1600 }, { x: 1500, y: 1200 },
    ];
    ...
    // 약초 노드 (15개)
    const herbPositions = [
      { x: 500, y: 200 }, { x: 700, y: 500 }, { x: 500, y: 800 },
      { x: 700, y: 1100 }, { x: 500, y: 1400 }, { x: 700, y: 1800 },
      { x: 1100, y: 300 }, { x: 1500, y: 500 }, { x: 1900, y: 300 },
      { x: 2500, y: 200 }, { x: 2300, y: 500 }, { x: 2500, y: 800 },
      { x: 2300, y: 1100 }, { x: 2500, y: 1400 }, { x: 2300, y: 1800 },
    ];
    ...
    const crystalPositions = [
      { x: 1500, y: 800 }, { x: 1400, y: 1000 }, { x: 1600, y: 1000 },
    ];
    ...
    const goldminePositions = [
      // 왼쪽
      { x: 350, y: 400 }, { x: 350, y: 800 }, { x: 350, y: 1200 }, { x: 350, y: 1600 },
      // 오른쪽
      { x: 2650, y: 400 }, { x: 2650, y: 800 }, { x: 2650, y: 1200 }, { x: 2650, y: 1600 },
    ];
